...
class UserReview(models.Model):
    ...
    rating = fields.Integer(string='Product Rating')
    rating2 = fields.Integer(compute="_get_rating", string="Product Rating 2")
    ...
    partner_id = fields.Many2one("res.partner", string="Odoo Customer", default=_get_partner)
