...
class ShippingFedex(models.Model):
    ...
    fedex_label_type = fields.Selection(selection=LABEL_TYPE, default='PNG')
    fedex_label_orientation = fields.Selection(string="Label Orientation", selection=LABEL_ORIENTATION, default=0)
    fedex_ftr_aes = fields.Char(string="B13A/AES/FTR Number")
    fedex_service_relation = fields.Char('Related Service', related='fedex_servicetype.code')
