...
class CustomerQuote(http.Controller):
    ...
    def customer_quote_modal(self, product_id, **kw):
        ...
        temp_id = request.env['ir.ui.view'].render_template("website_quote_system.customer_quote_template", {
            'prod_id': obj.id,
    ...
    def customer_quote_submit(self, **kw):
        ...
        temp_id = request.env['ir.ui.view'].render_template("website_quote_system.customer_quote_template_submit", values)
        return temp_id
